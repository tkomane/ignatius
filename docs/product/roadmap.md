...
| 005 PostgreSQL object explorer | Partly done | The tree, the palette and object definitions are in (`specs/007-object-definitions/spec.md`). Remaining: dependency navigation, indexes and extensions as tree nodes, and a dedicated metadata connection so a long query cannot delay the tree |
