...
| 005 PostgreSQL object explorer | Partly done | The tree with indexes and extensions in it, the palette, and object definitions are in (`specs/007-object-definitions/spec.md`). Remaining: dependency navigation, and a dedicated metadata connection so a long query cannot delay the tree |
