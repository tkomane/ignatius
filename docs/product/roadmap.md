...
| 005 PostgreSQL object explorer | Partly done | The tree with indexes and extensions in it, the palette, object definitions and a dedicated read-only connection for the tree are in (`specs/007-object-definitions/spec.md`). Remaining: dependency navigation |
